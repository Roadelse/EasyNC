...
type :: t1
    ...
    real*4 :: fsc1, farr1(3), farr2(2,3)
    real*4 :: fsc2, farr3(3), farr4(2,3)

    real*8 :: dsc1, darr1(3), darr2(2,3)
    real*8 :: dsc2, darr3(3), darr4(2,3)
end type
...
real*4 :: farrTemp(2,3) = reshape([1.,2.,3.,4.,5.,6.], [2,3])
real*8 :: darrTemp(2,3) = reshape([1.d0,2.d0,3.d0,4.d0,5.d0,6.d0], [2,3])
